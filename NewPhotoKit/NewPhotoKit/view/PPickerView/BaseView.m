...
- (UIButton *)cancelBtn {
    if (!_cancelBtn) {
        ...
        //设置按钮圆角或者边框
        if (self.pickerStyle.cancelBorderStyle == BorderStyleSolid) {
        ...
        } else if (self.pickerStyle.cancelBorderStyle == BorderStyleFill) {
            _cancelBtn.layer.cornerRadius = self.pickerStyle.cancelCornerRadius > 0 ? self.pickerStyle.cancelCornerRadius : 6.0f;
            _cancelBtn.layer.masksToBounds = YES;
        }
    }
...
- (UIButton *)doneBtn {
    if (!_doneBtn) {
        ...
        // 设置按钮圆角或边框
        if (self.pickerStyle.doneBorderStyle == BorderStyleSolid) {
        ...
        } else if (self.pickerStyle.doneBorderStyle == BorderStyleFill) {
            _doneBtn.layer.cornerRadius = self.pickerStyle.doneCornerRadius > 0 ? self.pickerStyle.doneCornerRadius : 6.0f;
            _doneBtn.layer.masksToBounds = YES;
        }
    }
...
- (PickerStyle *)pickerStyle {
    if (!_pickerStyle) {
        _pickerStyle = [[PickerStyle alloc]init];
    }
    return _pickerStyle;
}
